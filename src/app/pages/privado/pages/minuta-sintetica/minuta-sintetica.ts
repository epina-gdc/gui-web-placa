...
@Component({
  ...
  imports: [SeccionTitulos, SeccionBusqueda, ReactiveFormsModule,
    ...
    CommonModule,
    DatePickerModule,
    RadioButtonModule,SeccionBusquedaMinutas],
...
export class MinutaSintetica {
 ...
 years: Anio[] = [
  ...
  minuta:Minuta= {
    idMinuta: 1,
    servicios: [{servicio:{idServicio:1,desServicio:'Desayuno'},
      variedad:[{idVariedad:1,desVariedad:'Variedad 1',racion:135},{idVariedad:2,desVariedad:'Variedad 2',racion:135},
      { idVariedad:3, desVariedad: 'Variedad 3',racion:135 },{ idVariedad:4, desVariedad: 'Variedad 4',racion:135 },
      { idVariedad:5, desVariedad: 'Variedad 5',racion:135 },{ idVariedad:6, desVariedad: 'Variedad 6',racion:135 },
       {idVariedad:7, desVariedad: 'Variedad 7',racion:135 },{idVariedad:8, desVariedad: 'Variedad 8',racion:135 },
       {idVariedad:9, desVariedad: 'Variedad 9',racion:135 },{idVariedad:10, desVariedad: 'Variedad 10',racion:135 },
...
buscar(): void {
  ...
  this.datePipe.transform(
    this.filtroForm.get('fecha')?.value,
    'dd/MM/yyyy'
  ) ?? '';
